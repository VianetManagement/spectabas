defmodule SpectabasWeb.Router do
  ...
  scope "/health", SpectabasWeb do
    ...
    get "/backfill-datacenter-vpn", HealthController, :backfill_datacenter_vpn
  ...
  scope "/dashboard", SpectabasWeb do
    ...
    live_session :dashboard,
      ...
      live "/sites/:site_id/seo", Dashboard.SEOLive, :index
      ...
      live "/sites/:site_id/scrapers", Dashboard.ScrapersLive, :index
      ...
      live "/sites/:site_id/languages", Dashboard.LanguagesLive, :index
      ...
      live "/sites/:site_id/ip/:ip", Dashboard.IpProfileLive, :show
      ...
      live "/sites/:site_id/ad-churn", Dashboard.AdChurnLive, :index
      live "/sites/:site_id/time-to-convert", Dashboard.TimeToConvertLive, :index
      live "/sites/:site_id/ad-visitor-paths", Dashboard.AdVisitorPathsLive, :index
      live "/sites/:site_id/organic-lift", Dashboard.OrganicLiftLive, :index
      live "/sites/:site_id/visitor-quality", Dashboard.VisitorQualityLive, :index
      ...
      live "/sites/:site_id/logs", Dashboard.LogsLive, :index
