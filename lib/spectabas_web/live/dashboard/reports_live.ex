    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="flex items-center justify-between mb-8">
        <div>
          ...
          <h1 class="text-2xl font-bold text-gray-900 mt-2">Reports</h1>
        </div>
        <button
      ...
      <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr :if={@reports == []}>
              <td colspan="4" class="px-6 py-8 text-center text-gray-500">No reports configured.</td>
            </tr>
            <tr :for={report <- @reports} class="hover:bg-gray-50">
              <td class="px-6 py-4">
                <div class="text-sm font-medium text-gray-900">{report.name}</div>
                <div :if={report.description} class="text-sm text-gray-500">{report.description}</div>
              </td>
