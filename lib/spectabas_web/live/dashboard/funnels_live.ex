    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="flex items-center justify-between mb-8">
        <div>
          ...
          <h1 class="text-2xl font-bold text-gray-900 mt-2">Funnels</h1>
        </div>
        <button
      ...
      <div :if={@show_form} class="bg-white rounded-lg shadow p-6 mb-8">
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <div class="space-y-3">
              <div :for={{step, idx} <- Enum.with_index(@form_steps)} class="flex items-center gap-3">
          ...
          >
            ...
            <div class="flex-1">
              <div class="flex items-center justify-between mb-1">
                <span class="text-sm text-gray-900">{Map.get(step, "name", "Step #{idx + 1}")}</span>
                <span class="text-sm font-medium text-gray-900">{Map.get(step, "visitors", 0)}</span>
              </div>
      ...
      <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr :if={@funnels == []}>
              <td colspan="4" class="px-6 py-8 text-center text-gray-500">No funnels configured.</td>
            </tr>
