      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div class="divide-y divide-gray-50">
            <div :if={@transitions.previous == []} class="px-5 py-8 text-center text-sm text-gray-400">
            ...
            >
              <span class="text-sm text-indigo-600 font-mono truncate mr-4">{row["prev_page"]}</span>
              <span class="text-sm font-medium text-gray-600 tabular-nums">{row["transitions"]}</span>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div class="divide-y divide-gray-50">
            ...
            >
              <span class="text-sm text-indigo-600 font-mono truncate mr-4">{row["next_page"]}</span>
              <span class="text-sm font-medium text-gray-600 tabular-nums">{row["transitions"]}</span>
            </div>
          </div>
        </div>
