        ...
        items: [
          ...
          %{
            ...
            **No additional configuration needed** for React, Vue, Next.js, Nuxt, Svelte, Angular, or any framework that uses the History API.
            ...
            <!-- With external identity cookie -->
            <script defer data-id="YOUR_KEY"
              data-xid-cookie="_my_fp"
              src="https://b.example.com/assets/v1.js"></script>
            ```
            """
          }
      ...
      %{
        ...
        items: [
          %{
            ...
            The Funnels page automatically analyzes your conversion data and suggests funnels based on common page sequences taken by converting visitors (goal completers and purchasers) in the last 30 days. Each suggestion shows the page path with converter count. Click "Create" to turn any suggestion into a real funnel instantly. Requires at least 3 converters sharing the same path to appear as a suggestion.
