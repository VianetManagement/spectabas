defmodule Spectabas.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Spectabas.Repo)
  ...
  @doc """
  A changeset for updating profile fields (role, display_name, etc).
  """
  ...
  """
  def valid_password?(%Spectabas.Accounts.User{hashed_password: hashed_password}, password)
